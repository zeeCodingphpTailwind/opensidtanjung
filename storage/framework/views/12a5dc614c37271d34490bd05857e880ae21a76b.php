                    ...
                    <div id="bodyContent">
                        <div class="card card-body">
                            <?php $__currentLoopData = $list_ref; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li <?php echo e(jecho($lap, $key, 'class="active"')); ?>><a href="<?php echo e(ci_route("statistik.chart_gis_rt.{$key}.{$link}")); ?>" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Statistik Penduduk <?php echo e($data_title); ?>"><?php echo e($value); ?></a></li>
                ...
                <div class="collapse box-body no-padding" id="collapseStatBantuan">
                    <div class="card card-body">
                        <?php $__currentLoopData = $list_bantuan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li <?php echo e(jecho($lap, $key, 'class="active"')); ?>><a href="<?php echo e(ci_route("statistik.chart_gis_rt.{$key}.{$link}")); ?>" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Statistik Bantuan <?php echo e($data_title); ?>"><?php echo e($value); ?></a></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\opensid\resources\views/admin/gis/content_rt.blade.php ENDPATH**/ ?>