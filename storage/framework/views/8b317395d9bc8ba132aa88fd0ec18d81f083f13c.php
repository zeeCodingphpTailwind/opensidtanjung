...
<div class="modal-body">
    <?php if(!$id_pend): ?>
        <div class="form-group">
            <label for="id_pend">NIK / Nama Penduduk <?php echo e($id_pend); ?></label>
            <select class="form-control input-sm select2 required" id="id_pend" name="id_pend">
                ...
                <?php $__currentLoopData = $penduduk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($data['id']); ?>" <?= ($data['id'] == $id_pend) ? 'selected' : ''; ?>><?php echo e($data['nik']); ?> - <?php echo e($data['nama']); ?></option>
...
<div class="modal-footer">
    ...
    <button type="submit" class="btn btn-social btn-info btn-sm" id="ok"><i class='fa fa-check'></i> <?php echo e(!$id_pend ? 'Simpan' : 'Reset PIN'); ?> </button>
</div>
</form>
...
<?php /**PATH C:\laragon\www\opensid\resources\views/admin/layanan_mandiri/daftar/ajax_pin.blade.php ENDPATH**/ ?>